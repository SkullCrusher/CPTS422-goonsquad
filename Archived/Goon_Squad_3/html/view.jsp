...
<body>
	...
	<div class="content">
		<form id="ReceiptForm" disabled="true">
			<div id="receipt-title">Purchase Time:</div> <input type="text" id="ReceiptDate" name="purchaseTime" readonly/><br/>
			<div id="receipt-title">Store:</div>         <input type="text" id="store" name="store" readonly/><br/>
			<div id="receipt-title">Total Cost:</div>    <input type="text" id="totalCost" name="totalcost" readonly/><br/>
			<div id="receipt-title">Comments:</div>      <textarea id="comments" rows="4" cols="50" name="comments" readonly></textarea><br/>
		</form>
